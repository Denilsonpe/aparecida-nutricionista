...
function obtemInfoForm(form){
    ...
    var paciente = {//cria um objeto
        nome: form.nome.value,//uma propriedade do objeto c/ seu valor separada por ':'
...
function montaTr(paciente){// monta a tr com um novo paciente
